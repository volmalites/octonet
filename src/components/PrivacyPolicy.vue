    ...
    <section>
        ...
        <ul>
            ...
            <p>
                ...
                Company downloaded by You on any electronic device, named Octonet
            </p>
            </li>
            <li>
            <p>
                ...
                refers to Octonet, 682 Keet Avenue.
            </p>
            </li>
            <li>
        ...
        <ul>
            <li>
            <p>By email: office@octonet.co.za</p>
            </li>
            <li>
            <p>
                By visiting this page on our website:
                <a
                href="https://www.octonet.co.za/chat"
                rel="external nofollow noopener"
                target="_blank"
                >https://www.octonet.co.za/chat</a
                >
            </p>
            </li>
            <li>
            <p>By phone number: 0124409159</p>
            </li>
            <li>
            <p>By mail: 682 Keet Avenue, Les Marais, Pretoria, 0084</p>
            </li>
        </ul>
    </section>
    </div>
